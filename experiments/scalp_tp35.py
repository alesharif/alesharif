...
US, UE = "2023-11-01", "2024-04-01"
VLO, VHI = 2e6, 2e8
START = 2000.0; STAKE = 0.10; MAXPOS = 10
TP = 0.035; SL = 0.02; COST = 0.25; MAXHOLD = 3*24*12; WARMUP_D = 45
...
def main():
    ...
    months = pd.date_range("2024-01-01", "2024-03-01", freq="MS")
