#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Hybrid trailing-stop sweep (April 2026 (OOS)): which TRAIL value survives reality?
...
def main():
    start = parse("2026-04-01")
    end = parse("2026-05-01")
    ...
    print("\nHYBRID trailing-stop sweep (April 2026 (OOS), SL 1.5, 30s monitor)")
    print(f"{'TRAIL':<8}{'closed':>8}{'WR%':>7}{'PF':>7}{'PP':>7}"
          f"{'avgW%':>8}{'avgL%':>8}{'worst%':>8}{'return%':>9}")
    print("-" * 70)
    for trail in [0.2, 0.5, 0.8, 1.0, 1.2, 1.4, 1.5, 1.6, 1.8, 2.0]:
